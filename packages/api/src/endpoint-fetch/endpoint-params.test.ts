...
describe('EndpointParamObject', () => {
    ...
    it('allows optional unknown requestData when requestData is omitted on a body method', () => {
        type Result = EndpointFetchParamObject<
            typeof uncheckedBodyEndpoint,
            typeof HttpMethod.Post
        >;
    ...
    it('does not allow requestData when requestData is omitted on a no-body method', () => {
...
const uncheckedBodyEndpoint = defineEndpoint({
    path: '/unchecked-body',
    requests: {
        [HttpMethod.Post]: {
            responses: {
